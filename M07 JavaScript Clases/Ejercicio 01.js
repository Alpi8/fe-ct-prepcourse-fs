...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function () {
      ...
      //this. toma la clase, .split fragmenta la cadena de caractees, .reverse la pone al reves,
      // .join une otra vez la cadena de caracteres
      // Las comillas en .join es como si separara la caedna con , y las de .split quita las comillas
   }
}
