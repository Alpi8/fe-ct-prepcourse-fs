...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto
   // Tu código:
   //Esta linea la hago para actualizar commit.
   const gato = {
      nombre: (nombre) ,
      edad: (edad)  ,
      meow: function(){
...
function agregarPropiedad(objeto, propiedad) {
   ...
   // Retornar el objeto.
   // Tu código:
   index = objeto // se declara otra variable para poder trabajar con el index (Nombre recibido por parametro)
   index[propiedad] = null
   return index
}
...
function invocarMetodo(objeto, metodo) {
   ...
   // Tu código:
   objeto[metodo]() // El parentesis al final es para que ejecute la funcion
}
